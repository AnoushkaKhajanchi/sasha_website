    ...
    <main style={{ padding: 24, background: 'transparent', color: 'white' }}>
      ...
      <ProfileCard
        ...
        <div style={{marginTop:"10px"}}>
          <h1 style={{color:"#fbfafbff", fontSize:"40px"}}>My Superpowers</h1>
        ...
        <div style={{background:"#875bdec9", borderRadius:"15px", padding:"20px", marginBottom:"20px"}}>
        ...
        <DecryptedText
          ...
          <div style={{background:"#5bc6dec9", borderRadius:"15px", padding:"20px", marginBottom:"20px"}}>
         <div style={{fontSize:"30px", color:"#faf9fbff", fontWeight:"bold", marginTop:"10px"}}>
          ...
          <div style={{background:"#5b64dec9", borderRadius:"15px", padding:"20px", marginBottom:"20px"}}>
